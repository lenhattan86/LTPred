...
% NC -c 32768.0  -g 0.03125 for 100
% OK -c 32768.0  -g 0.03125 for 100
% OR -c 32768.0  -g 0.03125 for 100
% SC -c 32768.0  -g 0.03125 for 100
model = svmtrain(scale_label, scale_inst, '-t 2 -c 32768.0  -g 0.03125 -q');
...
%%
save(['errors/SVM/WIND/' trainDataFile '.mat'], 'predictedValues' , ...
    'expectedValues', 'accuracy', 'errors', 'Lat', 'Lon' );