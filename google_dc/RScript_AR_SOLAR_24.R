...
script.dir <- 'C:/Users/NhatTan/Dropbox/Papers/SoCC Prediction/google_dc'
#path <- "/PV/AL_PV_2006/"
...
# file_name <- "LA_31.17_-91.87_2007_2009.csv"; Lat <- as.numeric(substr(file_name, 4, 8)); Lon <- as.numeric(substr(file_name, 10, 15));
# file_name <- "ME_44.69_-69.38_2007_2009.csv"; Lat <- as.numeric(substr(file_name, 4, 8)); Lon <- as.numeric(substr(file_name, 10, 15));
# file_name <- "MI_43.33_-84.54_2007_2009.csv"; Lat <- as.numeric(substr(file_name, 4, 8)); Lon <- as.numeric(substr(file_name, 10, 15));
# file_name <- "MO_38.46_-92.29_2007_2009.csv"; Lat <- as.numeric(substr(file_name, 4, 8)); Lon <- as.numeric(substr(file_name, 10, 15));
# file_name <- "WY_42.76_-107.3_2007_2009.csv"; Lat <- as.numeric(substr(file_name, 4, 8)); Lon <- as.numeric(substr(file_name, 10, 15));

# file_name <- "CA_037.00_-120.00_2007_2009.csv"; Lat <- as.numeric(substr(file_name, 4, 9)); Lon <- as.numeric(substr(file_name, 11, 17));
# file_name <- "FL_027.77_-081.69_2007_2009.csv"; Lat <- as.numeric(substr(file_name, 4, 9)); Lon <- as.numeric(substr(file_name, 11, 17));
# file_name <- "ND_047.53_-099.78_2007_2009.csv"; Lat <- as.numeric(substr(file_name, 4, 9)); Lon <- as.numeric(substr(file_name, 11, 17));
# file_name <- "NE_041.13_-098.27_2007_2009.csv"; Lat <- as.numeric(substr(file_name, 4, 9)); Lon <- as.numeric(substr(file_name, 11, 17));
# file_name <- "NY_042.17_-074.95_2007_2009.csv"; Lat <- as.numeric(substr(file_name, 4, 9)); Lon <- as.numeric(substr(file_name, 11, 17));
# file_name <- "TX_031.05_-097.56_2007_2009.csv"; Lat <- as.numeric(substr(file_name, 4, 9)); Lon <- as.numeric(substr(file_name, 11, 17));
# file_name <- "WA_047.40_-121.49_2007_2009.csv"; Lat <- as.numeric(substr(file_name, 4, 9)); Lon <- as.numeric(substr(file_name, 11, 17));
