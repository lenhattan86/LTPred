...
% fileName  = 'CA_037.00_-120.00_2007_2009.csv'; 
% Lat = fileName(4:9); Lon = fileName(11:17); 
% svm_paramters = {'32.0', '8.0'};
% Percentile = 100;

% fileName  = 'FL_027.77_-081.69_2007_2009.csv'; 
% Lat = fileName(4:9); Lon = fileName(11:17); 
% svm_paramters = {'512.0', '0.03125'};
% Percentile = 100;

% todo: run grid.py
% fileName  = 'ND_047.53_-099.78_2007_2009.csv'; 
% Lat = fileName(4:9); Lon = fileName(11:17); 
% svm_paramters = {'32.0', '8.0'};
% Percentile = 100;

% fileName  = 'NE_041.13_-098.27_2007_2009.csv'; 
% Lat = fileName(4:9); Lon = fileName(11:17); 
% svm_paramters = {'32.0', '8.0'};
% Percentile = 100;


% fileName  = 'NY_042.17_-074.95_2007_2009.csv'; 
% Lat = fileName(4:9); Lon = fileName(11:17); 
% svm_paramters = {'32.0', '8.0'};
% Percentile = 100;

fileName  = 'TX_031.05_-097.56_2007_2009.csv'; 
Lat = fileName(4:9); Lon = fileName(11:17); 
svm_paramters = {'32.0', '8.0'};
Percentile = 100;

% fileName  = 'WA_047.40_-121.49_2007_2009.csv'; 
% Lat = fileName(4:9); Lon = fileName(11:17); 
% svm_paramters = {'32.0', '8.0'};
% Percentile = 100;

% fileName  = 'AL_34.65_-86.783_2007_2009.csv'; Lat = fileName(4:8); Lon = fileName(10:16); svm_paramters = {'32.0', '2.0'};

                       
% Load data
%importDataScript
   
[datetimeTemp,AmbienttemperatureC,ACinverterpowerW,Angleofincidencedeg, ...
    BeamirradianceWm2,DCarraypowerW,DiffuseirradianceWm2,GlobalhorizontalirradianceWm2,...
    ModuletemperatureC,PlaneofarrayirradianceWm2,...
    values,Shadingfactorforbeamradiation,Sunupoverhorizon01,TransmittedplaneofarrayirradianceWm2,Windspeedms] ...
    = importSAMSolar(strcat(path, fileName),  2, total_duration+1);
